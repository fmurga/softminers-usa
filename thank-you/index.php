...
<body>
    ...
    <?php $IPATH = $_SERVER["DOCUMENT_ROOT"]."/usa/assets"; include $IPATH."/components/header2.php"; ?>    
      ...
      <div class="vh-50 d-flex justify-content-center align-items-center">
        <div class="col-md-4 bg-white shadow-md p-5">
          ...
          <div class="text-center">
            ...
            <a class="btn btn-primary" href="/usa">Back Home</a>
          </div>
        </div>
    </section>
  </main>
  <?php $IPATH = $_SERVER["DOCUMENT_ROOT"]."/usa/assets"; include $IPATH."/components/footer2.php"; ?>
