...
if(! jQuery.trim(jQuery('input[name="your-email"]').val())) {
  jQuery('input[name="your-email"]').addClass('wpcf7-not-valid');
  jQuery('input[name="your-email"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Please, insert a valid e-mail address</span>');
  valid = false;
  return valid;
} else {
...
if(! jQuery.trim(jQuery('input[name="your-name"]').val())) {
  ...
  jQuery('input[name="your-name"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(! jQuery.trim(jQuery('input[name="cargo"]').val())) {
  ...
  jQuery('input[name="cargo"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
...
if(! jQuery.trim(jQuery('input[name="telefone"]').val())) {
  ...
  jQuery('input[name="telefone"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(! jQuery.trim(jQuery('input[name="mais-empresa"]').val())) {
  ...
  jQuery('input[name="mais-empresa"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(!jQuery('select[name="mais-necessidade"]').val()) {
  ...
  jQuery('select[name="mais-necessidade"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(!jQuery('select[name="mais-industria"]').val()) {
  ...
  jQuery('select[name="mais-industria"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(!jQuery('select[name="mais-pais"]').val()) {
  ...
  jQuery('select[name="mais-pais"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(!jQuery('select[name="mais-estado"]').val() && jQuery('select[name="mais-pais"]').val() == 6) {
  ...
  jQuery('select[name="mais-estado"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
...
if(jQuery('textarea[name="Mensagem"]').length > 0 && !jQuery('textarea[name="Mensagem"]').val()) {
  ...
  jQuery('textarea[name="Mensagem"]').parent().append('<span role="alert" class="wpcf7-not-valid-tip">Required Field</span>');
  valid = false;
  return valid;
}
