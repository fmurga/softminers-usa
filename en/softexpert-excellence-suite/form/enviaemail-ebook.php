<?php
	...
	$id_ebook = $_POST['postid'];
	$url_ebook = $_POST['url'];

	$textThanks = "You've registered to SoftExpert's website to download the following materials:";
	$textContact = "We will contact you shortly.";
	...
	$msg='
		...
		<body class="corpo">'
		."<p align=\"justify\" class=\"style1\"> <b>Hello ".utf8_encode($_POST['your-name'])."</b>,</p>"
		."<p align=\"justify\" class=\"style1\">" . $textThanks . "</p>"
		."<p align=\"justify\" class=\"style1\"> <b>" . $id_ebook . "</b>,</p>"
		."<p align=\"justify\" class=\"style1\"> <a href=\"" . $url_ebook . "\">" . $url_ebook . "</a></p>"
	...
	$mail->IsHTML(true);
	$mail->Subject ='Thanks for your interest in SoftExpert solutions';
	$mail->Body = $msg;
	$send=$mail->Send(); 
	unset($mail);
							...
							<table style=\"width: 450pt;\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\" width=\"750\">
								<tbody>
									...
									<tr style=\"height: 18pt;\" height=\"30\">
										<td style=\"width: 187.5pt; height: 18pt; background-color: rgb(175, 214, 250); padding: 0.75pt;\" width=\"312\">
											<span style=\"background-color: rgb(175, 214, 250);\">
												<div style=\"margin: 0pt;\"><font size=\"3\" face=\"Times New Roman,serif\"><span style=\"font-size: 12pt;\"><font color=\"#000066\">Ebook solicitado:</font></span></font></div>
											</span>
										</td>
										<td style=\"height: 18pt; background-color: rgb(175, 214, 250); padding: 0.75pt;\"><span style=\"background-color: rgb(175, 214, 250);\">
											<div style=\"margin: 0pt;\"><font size=\"3\" face=\"Times New Roman,serif\"><span style=\"font-size: 12pt;\">" . $id_ebook . "</span></font></div>
											</span>
										</td>
									</tr>
								</tbody>
	...
	error_log($send);
	echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0; URL=https://www.softexpert.com/sesuite-sitemod\"><script type=\"text/javascript\">alert('FORM SUCCESSFULLY SENT');</script>";
